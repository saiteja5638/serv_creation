...
service CatalogService {
    ...
    entity SALES_HIS              as projection on db.SALES_HIS; //sales history
    entity SALES                  as projection on db.SALES1; //sales
    ...
    entity CUSTOMERS              as projection on db.CUSTOMERS; //customers
    ...
    entity CUSTOMERS_STB          as projection on db.CUSTOMERS_STB; // customers_stb
    ...
    entity SALES_STB              as projection on db.SALES1_STB; //sales_stb
    entity SALES_HIS_STB          as projection on db.SALES_HIS_STB; //sales_his_stb
